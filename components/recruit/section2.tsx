      ...
      <div className='w-[1180px] pt-[160px] pb-[120px] lg:w-[720px] lg:pt-[100px] lg:pb-[80px] md:w-[327px] md:pt-[80px] md:pb-[60px]'>
        ...
        <div className='mt-[161px] lg:mt-[100px] md:mt-[60px]'>
          <div className='flex justify-between space-x-10 md:flex-col md:space-x-0 md:space-y-[28px]'>
            ...
            <div className='w-1/4 h-[196px] md:hidden' />
          </div>
        </div>
        ...
        <div className='mt-[68px] md:mt-[60px]'>
          <div className='flex justify-between space-x-10 md:flex-col md:space-x-0 md:space-y-[28px]'>
            ...
            <div className='w-1/4 h-[196px] border-b border-[#d1d1d1] md:w-[327px] md:h-auto md:pb-[28px]'>
              ...
              <div className='text-[#292e33] leading-[1.6] mt-[20px] md:mt-[8px]'>
                생일 10만원 상품권 지급과 <br className='lg:hidden' />
                2시간의 <br className='hidden md:block' />
                Early Bye를 제공합니다.
              </div>
            </div>
        ...
        <div className='mt-[68px] md:mt-[60px]'>
          <div className='flex justify-between space-x-10 md:flex-col md:space-x-0 md:space-y-[28px]'>
            ...
            <div className='w-1/4 h-[196px] border-b border-[#d1d1d1] md:w-[327px] md:h-auto md:pb-[28px]'>
              ...
              <div className='text-[#292e33] leading-[1.6] mt-[20px] md:mt-[8px]'>
                자기개발, 여가, 취미활동을 위해 <br className='lg:hidden' />
                연 360만원 <br className='hidden md:block' />
                한도의 복지카드를
            ...
            <div className='w-1/4 h-[196px] border-b border-[#d1d1d1] md:w-[327px] md:h-auto md:pb-[28px]'>
              ...
              <div className='text-[#292e33] leading-[1.6] mt-[20px] md:mt-[8px]'>
                풍요로운 명절에 감사의 마음을 <br className='lg:hidden' />
                전하기 위해 <br className='hidden md:block' />
                설과 추석에 각각 30만원씩
                <br className='lg:hidden' />
                지급합니다.
              </div>
