  ...
  return (
    <div className='flex justify-center'>
      <div className='w-[1180px] pt-[204px] pb-[160px] md:pt-[100px] md:pb-[60px]'>
        <Link href='/recruit'>
          <a className='flex justify-between items-center bg-[#2a282b] w-full h-[148px] px-[60px] md:flex-col md:justify-center md:h-[201px] md:px-0 group'>
            ...
            <div className='flex items-center space-x-[10px] md:mt-[40px] md:w-[330px]'>
              ...
              <div className='relative w-[18px] h-[18px] group-hover:translate-x-2 transition-all'>
                <Image
                  src='/tmp/2/section6/arrow-right.png'
