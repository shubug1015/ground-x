...
const Section1: NextPage = () => {
  ...
  return (
    <div
      className='relative h-[4000px] bg-indogo-500'
      style={{
    ...
    >
      ...
      <h1
        className='fixed top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 text-center text-[4.25rem] text-white font-bold leading-[1.5]'
        style={{
      ...
      <h2
        className='fixed top-[30%] left-1/2 -translate-x-1/2 text-center text-2xl text-white font-medium leading-10'
        style={{
      ...
      <h2
        className='fixed top-[45%] left-1/2 -translate-x-1/2 text-center text-2xl text-white font-medium leading-10'
        style={{
      ...
      <h2
        className='fixed top-[60%] left-1/2 -translate-x-1/2 text-center text-2xl text-white font-medium leading-10'
        style={{
