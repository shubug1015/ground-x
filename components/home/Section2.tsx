...
const Section2: NextPage = () => {
  return (
    <Grid>
      <h1 className='text-[#12161a] text-5xl font-bold leading-[1.5]'>
        디지털 자산의
        <br />
        경계선을 지웁니다.
      </h1>

      <h2 className='text-[#12161a] text-lg mt-7'>
      ...
      <div className='flex-between-center space-x-10 mt-[6.25rem] mb-[13.75rem]'>
        <div className='relative h-[32.5rem] w-1/3 rounded-xl pt-[3.75rem] pl-8 overflow-hidden group'>
          <Image
          ...
          <div className='absolute text-white'>
            ...
            <div className='leading-[1.6] mt-5 opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all'>
