...
const Section7: NextPage = () => {
  return (
    <div className='flex justify-center bg-[#ebedf0]'>
      <div className='w-[1180px] py-20 lg:h-auto lg:py-[80px] md:h-auto md:py-[40px]'>
        <Link href='/recruit'>
          <a className='flex justify-between items-center w-full h-full lg:flex-col lg:justify-center lg:items-center lg:px-0 md:px-0 group'>
